...
<head>
    ...
    <title>UMIT Training and Placement Cell</title>
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-12 col-md-6 text-center">
                <img id="img2" src="images/u3.jpg" class="img-fluid" alt="UMIT Training and Placement Cell">
            </div>
                    ...
                    <section>
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="registrationType" id="studentRadio" value="student" required>
                                <label class="form-check-label" for="studentRadio">
                                    <a href="sregister.php">Student</a>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="registrationType" id="companyRadio" value="company" required>
                                <label class="form-check-label" for="companyRadio">
                                    <a href="cregister.php">Company</a>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="registrationType" id="adminRadio" value="admin" required>
                                <label class="form-check-label" for="adminRadio">
                                    <a href="aregister.php">Admin</a>
                                </label>
                            </div>
                        </div>
                    </section>
...
<footer class="footer-wrap" style="margin-top: 80px;">

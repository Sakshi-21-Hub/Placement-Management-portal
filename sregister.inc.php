...
<body>
    <?php 
            ...
            if (isset($_POST['signup'])) {
                ...
                if ($pwd1 == $pwd2) {
                    $sql = "insert into studentlogin(uname, prn, pwd, fname, lname, email, phone, secque, secans) values('$uname','$prn', '$hashed_password', '$fname', '$lname', '$email', '$phone', '$secque', '$secans');";
                    mysqli_query($conn, $sql);
                    ?>           
                <div class="container" style="margin-top: 80px; margin-left: 100px;">

...
<body>
    <div class="container content-container">
        <div class="text-center">
            <h1>Resume</h1>
            <a href="https://pgdavplacementcell.in/blog/PCResumeTemplate.docx">
                <button type="button" class="btn btn-primary download-btn"style="margin-left: 200px;">Download Resume Template</button>
            </a>
        </div>
        <div class="row justify-content-center mt-5">
            <div class="col-md-10 text-center">
                <img src="../images/img1.png" width="60%" height="70%" class="img-fluid" alt="Resume Image">
            </div>
        </div>
        <div class="mt-5">
            <h4 class="section-title">Include the following on top of your resume, below your name:</h4>
            <div class="content-text"><span>1. Address (City, State)</span></div>
            <div class="content-text"><span>2. Phone No.</span></div>
            <div class="content-text"><span>3. Professional Email Id (Avoid too many numeric characters, make sure it has your full name)</span></div>
            <div class="content-text"><span>4. LinkedIn URL</span></div>
        </div>
        <div class="mt-5">
            <h4 class="section-title">Objective</h4>
            <div class="content-text">Avoid a generic objective. Try to showcase your personal brand and highlight your passion.</div>
            <div class="content-text"><b>Sample Answer:</b><br><br>Commerce undergraduate with a minor in Economics (type in your GE). I am a highly driven individual seeking a full-time opportunity where I can leverage my existing knowledge to drive innovation and change.<br><br>Or<br><br>Statistics major seeking role as an actuarial analyst. I am passionate about technology, meeting people and exploring new avenues.</div>
        </div>
        <div class="mt-5">
            <h4 class="section-title">Education</h4>
            <div class="content-text">Always mention your education on top of the body of your resume as an undergraduate. YOUR EDUCATION SHOULD BE LISTED IN REVERSE CHRONOLOGICAL ORDER.</div>
            <div class="content-text"><span>1. College</span></div>
            <div class="content-text"><span>2. XII<sup>th</sup></span></div>
            <div class="content-text"><span>3. X<sup>th</sup></span></div>
        </div>
        <div class="mt-5">
            <ul>
                <li>Next, list down any RELEVANT internship experience while focusing on your roles and responsibilities and highlighting the targets you might have achieved.</li>
                <li>Next, list any volunteering activity or student club that you’re a part of. Again, make sure to highlight the work you did and the impact you created.</li>
                <li>Mention your skills and languages known. Do not mention generic skills or irrelevant skills like surfing the net, watching movies, or listening to music.<br>Add something that will help you along with this job. E.g- SQL (Beginner), Excel (Advanced), Python (Intermediate), PowerPoint (Advanced).</li>
                <li>DO NOT MENTION ANY SCHOOL LEVEL ACHIEVEMENT.<br>Make sure to customize your resume as per the job description and the profile offered.</li>
            </ul>
        </div>
    </div>

                    ...
                    <ul class="navMenu">
                                ...
                                class="active" title="Query">
                                                        ...
                                                        <ul class="dropMenu">
                                                                                                                                ...
                                                                                                                                <li><a href="askquery.php" class="active" title="Add Student">
                                                                                Ask Query
                                        </a></li>
...
<body>
    <section>
        <div class="container">
        <h2 class="text-center mb-5"style="margin-top:1px; color:black;">Ask Query</h2>

        <div class="d-flex justify-content-center mb-4">
            <a href="viewquery.php" class="btn btn-primary" style="background: linear-gradient(to left, #4181ED, #3F4261)">View all the Queries</a>
        </div>

        <form action="php/query.inc.php" method="post" class="mb-5">
        <div class="form-row ">
        ...
        <div class="form-row ">
            <div class="col-md-12 mb-3">
                ...
                <textarea class="form-control" id="query" name="query" rows="4" placeholder="Write your query here" required pattern=".{5,}"></textarea>
                    <div class="invalid-feedback">
                        Enter your Query
                    </div>
            </div>
        </div>
            <button type="submit" name="add-query" class="btn btn-primary btn-block"style="background: linear-gradient(to left, #4181ED, #3F4261)">Add Query</button>
        </form>
    </div>

...
<head>
    ...
    <title>UMIT Placement Management Portal</title>
    <!-- Bootstrap CSS -->
                ...
                <div class="resMainmenu">
                    ...
                    <ul class="navMenu">
                                ...
                                class="active" title="Query">
                                        ...
                                        <li><a href="viewquery.php" class="active" title="View Query">
                                                                                View Query
                                        </a></li>                                                                                                
                                                                                            </ul>
                                                    </li>
                ...
                <tbody>
                    <?php
                        ...
                        if(mysqli_num_rows($res) > 0) {
                            ...
                            echo '<tr><td colspan="3" class="text-center">No queries found.</td></tr>';
                        }
                    ?>
                </tbody>
            </table>

            ...
            <div class="menuPage">
                <div class="resMainmenu">
                    ...
                    <ul class="navMenu">
                                ...
                                class="active" title="StudyMaterial">
                                                                View Study Material
                                                                 </a>
                                                     </li>
...
<main>
<div class="container">
        <h1 class="form-row justify-content-center mt-4"style=" 
            text-align: center;
            margin-top: 30px;
            padding: 20px 0;
            background-color: #fff;
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                echo "<a href='" . $row["file_url"] . "' class='btn btn-primary'>Download</a>";
                echo "</div>";
            }
        } else {
            echo "<p class='mt-4'>No study materials available.</p>";
        }
        ?>
    </div>

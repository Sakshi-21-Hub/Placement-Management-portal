...
<div class="container">
    ...
    <div class="contact-section">
        <div class="contact-card">
            ...
            <p><strong>Dr. Vilas Kharat</strong><br/>Placement Coordinator, Training and Placement Cell</p><br>
            <p><strong>Ms. Aarti</strong><br/>Committee, Training and Placement Cell</p><br>
            <p><strong>Mr. Sudhakar Yerme</strong><br/>Technical Head, Training and Placement Cell</p>
        </div>
        <div class="contact-card">
            <h2>Support Office Staff</h2>
            <p>Mr. Subodh Chavan, Mr. Nitin Shinde &amp; Mr. Rajesh Nanarkar</p><br>
            <h2>Address</h2>
            <p>Training &amp; Placement Cell,<br/>Usha Mittal Institute of Technology,<br/>Mumbai - 400049</p>
        </div>
        <div class="contact-card">
            <h2>Contacts</h2>
            <p><strong>Email:</strong> placements@umit.sndt.ac.in<br/><strong>Phone:</strong> +91 9820161954</p>
        </div>
    </div>
    ...
    <div class="col-md-12" >
        ...
        <p>UMIT Training And Placement Cell</b> is an application mainly developed for UMIT College to add and maintain companies
    ...
    <div class="col-md-12" style="margin-top: 50px;">
        <hr/>
        <h2 class="heading">How to Reach Usha Mittal Institute of Technology</h2>
        <p>To reach Usha Mittal Institute of Technology (UMIT) in Santacruz, you can follow various transportation options:</p>
        <h3>Reaching Usha Mittal Institute of Technology (UMIT):</h3>
        <p><strong>1) BY AIR:</strong> The approachable airport to the city is Santacruz which is approximately 3.9 km away from UMIT. One can easily get a direct flight to Santacruz from cities like Delhi, Agra, Khajurao, Kolkata, Mumbai, Lucknow and Bhubaneshwar airport. The taxi charges from Airport to UMIT Campus are about INR 600/-.</p>
        <p><strong>2) BY RAIL:</strong> Mumbai is well-connected to major cities across India via rail. You can reach Mumbai by train and then use local trains, buses, or taxis to reach UMIT.</p>
    </div>

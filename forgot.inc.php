...
if (isset($_POST['ehelp'])) {
    ...
    if ($row = mysqli_fetch_assoc($res)) {
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputEmail1" name="secque"
                   value="<?php echo $row['secque']; ?>" style="width: 350px;" disabled>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputEmail1" name="answer"
                   placeholder="Answer" style="width: 350px;">
        </div>
        ...
        <?php
    } elseif($row = mysqli_fetch_assoc($res1)){
      ?>
      <div class="form-group">
          <label for="exampleInputEmail1">Security Question</label>
          <input type="text" class="form-control" id="exampleInputEmail1" name="secque"
    ...
    } elseif($row = mysqli_fetch_assoc($res2)){
      ?>
      <div class="form-group">
          <label for="exampleInputEmail1">Security Question</label>
          <input type="text" class="form-control" id="exampleInputEmail1" name="secque"
      ...
      <?php
        ...
        <script type="text/javascript">
            alert("Wrong email");
            window.location.replace("../Major_Project_B/login.php");
          </script>
        <?php
    }
}

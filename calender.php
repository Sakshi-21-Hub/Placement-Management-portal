...
<h1 style="margin-top: 40px;">UMIT Placement and Internship Calendar 2023-24</h1>
    <div class="clearfix " style="background-color: white;">
        <ol start="1">
            <!-- Your content here -->
        </ol>
    </div>
    <div class="custom-container white-bg" id="master_wrapper" style="margin-left: 50px; margin-top: 30px;">
    ...
    <tbody>
        <tr>
            <td>19 May 2024</td>
            <td>Declaration of even semester 2023-2024 results</td>
        </tr>
        <tr>
            <td>24-27 May 2024</td>
            <td>Registration of new candidates on the placement portal and verification of academic credentials</td>
        </tr>
        <tr>
            <td>24-27 June 2024</td>
            <td>Resume field entry by candidates on the placement portal</td>
        </tr>
        <tr>
            <td>28 June - 4 July 2024</td>
            <td>Verification of resume fields by TPRs</td>
        </tr>
        <tr>
            <td>7 July 2024</td>
            <td>Willingness open for internship opportunities</td>
        </tr>
        <tr>
            <td>21 July 2024</td>
            <td>Start of Academic Session 2024-2025</td>
        </tr>
        <tr>
            <td>22 July 2024</td>
            <td>Beginning of internship tests</td>
        </tr>
        <tr>
            <td>29-30 July 2024</td>
            <td>Beginning of internship interviews</td>
        </tr>
        <tr>
            <td>1-7 August 2024</td>
            <td>Placement portal registration and field addition of full-time aspirants</td>
        </tr>
        <tr>
            <td>7-12 August 2024</td>
            <td>Placement document verification by TPC</td>
        </tr>
        <tr>
            <td>15 August 2024</td>
            <td>Willingness open for full-time opportunities and beginning of full-time assessments</td>
        </tr>
        <tr>
            <td>December 1, 2024</td>
            <td>Beginning of full-time interviews</td>
        </tr>
    </tbody>
</table>

                    <b>* Written/Online tests will be permitted only when it does not clash with the schedule of interviews of the other companies.</b>
                </div>
                <hr />
                <h2>TPC Activities and processes shall be avoided on the following occasions:</h2>
<table class="table table-striped" style="margin-bottom: 50px;">
    ...
    <tbody>
        ...
        <tr>
            <td>17-24 October 2024</td>
            <td>Dussehra Break</td>
        </tr>
        <tr>

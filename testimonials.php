...
.users .owl-carousel .owl-stage {
    display: flex;
    align-items: stretch;
}

.users .owl-carousel .owl-item {
    display: flex;
    align-items: stretch;
}
...
<section id="users" class="users">
    <div class="container aos-init aos-animate" data-aos="fade-up" style="max-width: 1200px; margin: 0 auto;">
        <h1>Testimonials</h1>
        <div class="owl-carousel owl-theme">
            <div class="item">
                <div class="card">
                    <img src="images/vaishnavi_desai.png" class="card-img-top" alt="Vaishnavi Desai">
                    <div class="card-body">
                        <h5 class="card-title">Vaishnavi Desai</h5>
                        <p class="card-text">"Choosing Umit College for my studies was one of the best decisions I've ever made. The faculty here is incredibly supportive and knowledgeable. They go above and beyond to ensure that we not only understand the material but also apply it in real-world situations. The resources available, from advanced labs to career counseling, have truly enhanced my learning experience. I feel well-prepared for my future career in technology."</p>
                    </div>
                </div>
            </div>
            <div class="item">
                <div class="card">
                    <img src="images/swathi_shetty.png" class="card-img-top" alt="Swathi Shetty">
                    <div class="card-body">
                        <h5 class="card-title">Swathi Shetty</h5>
                        <p class="card-text">"Umit College has a vibrant campus life that makes learning so much more enjoyable. The extracurricular activities and student clubs have helped me develop my leadership and organizational skills. The networking opportunities are fantastic, and I’ve been able to connect with industry professionals and alumni who have provided invaluable guidance and mentorship. I’m confident that the education and experiences I’ve gained here will propel me towards success in the business world."</p>
                    </div>
                </div>
            </div>
            <div class="item">
                <div class="card">
                    <img src="images/vandita_rai.png" class="card-img-top" alt="Vandita Rai">
                    <div class="card-body">
                        <h5 class="card-title">Vandita Rai</h5>
                        <p class="card-text">"The inclusive and diverse environment at Umit College has been incredibly enriching. As a psychology major, I appreciate how the curriculum is designed to provide both theoretical knowledge and practical experience. The internships and research opportunities have given me a deep understanding of the field and prepared me for graduate studies. The supportive community of professors and peers has made my time here truly memorable."</p>
                    </div>
                </div>
            </div>
            <div class="item">
                <div class="card">
                    <img src="images/irit_khushwaha.png" class="card-img-top" alt="Irit Khushwaha">
                    <div class="card-body">
                        <h5 class="card-title">Irit Khushwaha</h5>
                        <p class="card-text">"Umit College has exceeded my expectations in every way. The engineering program is rigorous and challenging, but the professors are always there to help and guide us. The hands-on projects and state-of-the-art facilities have allowed me to apply what I’ve learned in class to real-world problems. I also appreciate the college’s emphasis on teamwork and innovation, which are crucial skills in the engineering field. I feel ready to tackle any challenge after graduation."</p>
                    </div>
                </div>
            </div>
            <div class="item">
                <div class="card">
                    <img src="images/dhurva_kamble.png" class="card-img-top" alt="Dhurva Kamble">
                    <div class="card-body">
                        <h5 class="card-title">Dhurva Kamble</h5>
                        <p class="card-text">"My experience at Umit College has been nothing short of amazing. The campus is beautiful, and the sense of community here is strong. The Environmental Science program is outstanding, with a focus on sustainability and conservation. I’ve had the chance to participate in fieldwork, internships, and research projects that have given me practical skills and a deeper appreciation for the environment. The dedication of the faculty to our education and future careers is truly inspiring."</p>
                    </div>
                </div>
            </div>
        </div>
...
$(document).ready(function(){
    $(".owl-carousel").owlCarousel({
        ...
        responsive: {
            ...
            1800: {
                items: 5 // 5 items on ultra-large screens
            }
        }
    });
});

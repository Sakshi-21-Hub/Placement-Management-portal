                ...
                <div class="resMainmenu">
                    ...
                    <ul class="navMenu">
                                ...
                                class="faIcon" title="About">
                                                        ...
                                                        <ul class="dropMenu">
                                                                                                <li><a href="placementfacilities.php" title="About SAMEER">
                                                                                Placement Cell
                                        </a></li>
...
<head>
    ...
    <title>UMIT Training and Placement Cell Web - Facilities</title>
...
<body>
    <h1>UMIT Placement facilities</h1>
 <div class="clearfix ">
        <p class="font_control">The placement office is well equipped and is designed to smoothly handle and support the placement procedure at every stage. Arrangements for interviews, group discussions and pre-placement talks are handled by the staff at the placement office. We are equipped with the following facilities to aid the process:</p>
        <ul>
    ...
    <!-- This is where you should paste the added content -->

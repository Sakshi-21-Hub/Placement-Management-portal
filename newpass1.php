...
<body>
        ...
        <div class="topnav" id="myTopnav">
            ...
            <div class="menuPage">
                <div class="resMainmenu">
                    ...
                    <ul class="navMenu">
                                                                                                                        <li class=""><a href="http://localhost/Major/Major_Project_B/index.php"
                                class="active" title="Home">
                                                                Home
                                                                 </a>
                                                    </li>
                                                                                                <li class="menuHover"><a href="#"
                                class="faIcon" title="About">
                                                                Guidelines
                                                                 <i class="fa fa-caret-down"></i>  </a>
                                                        <ul class="dropMenu">
                                                                                                <li><a href="placement.php" title="About SAMEER">
                                                                                Placement Cell
                                        </a></li>
                                                                                                                                <li><a href="placementguideline.php" title="Director General Profile">
                                                                                Placement Guidelines
                                        </a></li>
                                                                                            </ul>
                                                    </li>
                                                                                                <!-- <li class="menuHover"><a href="#"
                                class="faIcon" title="Organization">
                                                                Organization
                                                                 <i class="fa fa-caret-down"></i>  </a>
                                                        <ul class="dropMenu">
                                                                                                <li><a href="https://sameer.gov.in/organization_chart" title="Organization Chart">
                                                                                Organization Chart
                                        </a></li>
                                                                                                                                <li><a href="https://sameer.gov.in/Governing_council" title="Governing Council">
                                                                                Governing Council
                                        </a></li>
                                                                                                                                <li><a href="https://sameer.gov.in/executive_council" title="Executive Council">
                                                                                Executive Council
                                        </a></li>
                                                                                                                                <li><a href="https://sameer.gov.in/who_is_who" title="Who&#039;s Who">
                                                                                Who&#039;s Who
                                        </a></li>
                                                                                            </ul>
                                                    </li> -->
  ...
  <head>
    ...
    <title>UMIT  training and placement cell web - Change Password</title>
  </head>
  ...
  <body>
    ...
    <form action="php/newpass1.php" autocomplete="off" method="POST">
            ...
            <div class="row">
                <div class="col-lg-2">
                    <div class="footer-box">
                        <a class="footer-logo" href="https://sameer.gov.in" title="SAMEER"><img
                                src="images/logo/logo.png" alt="SAMEER"></a>

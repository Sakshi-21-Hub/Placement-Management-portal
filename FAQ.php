        ...
        <div id="accordion">
            <div class="accordion-item">
                ...
                <div id="collapse1" class="accordion-body collapse">
                    <p>The training and placement cell acts as a bridge between students and potential employers. It facilitates career guidance, training programs, and placement opportunities for students.</p>
</div>
            </div>
            <div class="accordion-item">
                ...
                <div id="collapse2" class="accordion-body collapse">
                    <p>Students can register with the training and placement cell through our online portal. Simply fill out the registration form with your details and submit it. You will then receive further instructions via email.</p>
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <div id="collapse2" class="accordion-body collapse">
                    <p>We offer a range of training programs to enhance students' employability skills. These may include technical training, soft skills development, mock interviews, resume building workshops, and industry-specific seminars.</p>
                </div>
            </div>

            <div class="accordion-item">
                <div class="accordion-header" data-toggle="collapse" data-target="#collapse2">
                Do you assist with internships as well?
                </div>
                <div id="collapse2" class="accordion-body collapse">
                    <p>Yes, we assist students in securing internships with reputable organizations. We facilitate connections with companies offering internships relevant to students' fields of study.</p>
                </div>
            </div>
            
            <div class="accordion-item">
                <div class="accordion-header" data-toggle="collapse" data-target="#collapse2">
                What companies visit our campus for placements?
                </div>
                <div id="collapse2" class="accordion-body collapse">
                    <p>We have a diverse network of companies that visit our campus for placements. These include both multinational corporations and startups across various sectors such as IT, engineering, finance, consulting, and more.</p>
                </div>
            </div>

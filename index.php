...
<head>
    ...
    <title>UMIT Training and Placement Cell Web</title>
    <link rel="stylesheet" type="text/css" href="css/reg.css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Arial:wght@400&display=swap">
    <link rel="stylesheet" type="text/css" href="css/styles.css"> <!-- External CSS file for styling -->
    ...
    <div class="bannerSlider">
        ...
        <br>
            <div class="row">
                <div class="col-lg-4 text-center">
                    <div class="box">
                        <img src="images/type/admin.png" class="img-fluid" width="50%" alt="">
                        <a style="text-decoration: none; color: inherit;" href="login.php">
                            <h3>Admin</h3>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 text-center">
                    <div class="box" >
                        <img src="images/type/student.png" class="img-fluid" width="48%" alt="">
                        <a style="text-decoration: none; color: inherit;" href="login.php">
                            <h3>Student</h3>
                        </a>
     ...
     <div class="section">
                ...
                <p class="section-description">
                    The Training & Placement Cell of the Institute, established in the academic year 2000-2001, aims to bring
                    various national and multinational companies to the campus. Students undergo training for aptitude tests,
                    group discussions, personal interviews, and technical interviews with industry participation.
                </p>
                <p class="section-description">
                    Regular Industry Interaction Forums are organized to orient students with career prospects in their chosen
                    field and bridge the gap between academic aspirations and industry expectations. Leading IT companies
                    participate, providing valuable insights into their company profiles and discussing career opportunities
                    for fresh engineers.
                </p>
            </div>
            <div class="section">
                ...
                <div style="text-align: center; margin-top: 50px;">
                    <p class="testimonial">
                        <span class="testimonial-author" style="margin-left:7px;">Vaishnavi Desai</span>
                        "UMIT College has been instrumental in shaping my career path. The faculty's dedication to excellence
                        and the vibrant campus atmosphere made my learning experience truly memorable. I am proud to be a UMIT
                        graduate."
                    </p>
                    <p class="testimonial">
                        <span class="testimonial-author">Manishi Pandey</span>
                        "As an international student, I found UMIT College to be incredibly welcoming and inclusive. The
                        support services for international students helped me seamlessly transition into university life. I am
                        grateful for the diverse community and enriching educational experience."
                    </p>
                    <p class="testimonial">
                        <span class="testimonial-author">Shruti Pandey</span>
                        "UMIT College goes beyond academics; it fosters holistic development. Through various clubs, societies,
                        and community initiatives, I learned invaluable leadership and teamwork skills. UMIT truly prepares
                        students for success in both their careers and personal lives."
                    </p>
                    <p>
                        <a href="testimonials.php" style="margin-left: 10%;">More</a>
                    </p>
                </div>
            </div>
    ...
    #placementTable tr:hover {
        ...
        @keyframes scroll {
            ...
            100% {
                ...
                <!-- Campus Drive content... -->
                <div class="row">
    <div class="col-lg-4">
        <div class ="card">
            <img src="logo/Deutsche-Bank.jpg" alt="Deutsche Bank Logo" style="max-width: 100%; height: auto;">
        </div>
    </div>
    <div class="col-lg-4">
    <div class ="card">
            <img src="logo/barclays.jpg" alt="Barclays Logo" style="max-width: 100%; height: auto;">
          
        </div>
    </div>
    <div class="col-lg-4">
    <div class ="card">
            <img src="logo/tcs.png" alt="TATA Logo" style="max-width: 100%; height: auto;">
...
<div class="row">
    <div class="col-lg-4">
    <div class ="card">
            <img src="logo/providence.png" alt="Providence Logo" style="max-width: 100%; height: auto;">
        
        </div>
    </div>
    <div class="col-lg-4">
    <div class ="card">
            <img src="logo/Oracle.png" alt="Oracle Logo" style="max-width: 100%; height: auto;">
           
        </div>
    </div>
    <div class="col-lg-4">
    <div class ="card">
            <img src="logo/JP Morgan & Chase.png" alt="JP Morgan Logo" style="max-width: 100%; height: auto;">
            
        </div>
    </div>
    <div class="col-lg-4">
    <div class ="card">
            <img src="logo/bank_of_america.jpeg" alt="Bank of America Logo" style="max-width: 100%; height: auto;">
           
        </div>
    </div>
    <div class="col-lg-4">
    <div class ="card">
            <img src="logo/Colgate.png" alt="Colgate Logo" style="max-width: 100%; height: auto;">
            
        </div>
    </div>
    <div class="col-lg-4">
    <div class ="card">
            <img src="logo/amdocs.png" alt="Amdocs Logo" style="max-width: 100%; height: auto;">
        
        </div>
    </div>
    <div class="col-lg-4">
    <div class ="card">
            <img src="logo/Visa.png" alt="Visa Logo" style="max-width: 100%; height: auto;">
           
        </div>
    </div>
    <div class="col-lg-4">
    <div class ="card">
            <img src="logo/accenture.png" alt="Accenture Logo" style="max-width: 100%; height: auto;">
           
        </div>
    </div>
    <div class="col-lg-4">
    <div class ="card">
            <img src="logo/Capgemini.png" alt="Capgemini Logo" style="max-width: 100%; height: auto;">
    ...
    <div class="container" style="margin-top: 10px;">
        ...
        <h1 style="color: black;">Placement Statistics</h1>
        <hr style="border-top: 2px solid black; margin-bottom: 20px; font-weight: bold;">
        <style>
        ...
        <table id="placementTable">
            ...
            <tbody>
                <tr>
                    <td>2021-22</td>
                    <td><a href="https://www.umit.ac.in/_files/ugd/bb8ca0_4c07a9dcb7b5487aa742334ee48c6a3b.pdf" target = "_blank">22</a></td>
                    <td><a href="https://www.umit.ac.in/_files/ugd/db66c0_1c6d8472503e4f51b563ebd1497efc47.pdf" target = "_blank">177</a></td>
                    <td>19.63 LPA</td>
                </tr>
                <tr>
                    <td>2020-21</td>
                    <td><a href="https://www.umit.ac.in/_files/ugd/bb8ca0_4c07a9dcb7b5487aa742334ee48c6a3b.pdf" target = "_blank">16</a></td>
                    <td><a href="https://www.umit.ac.in/_files/ugd/db66c0_4ce7923e68b449399a10e4d671954eab.pdf" target = "_blank">159</a></td>
                    <td>19.63 LPA</td>
                </tr>
                <tr>
                    <td>2019-20</td>
                    <td><a href="https://www.umit.ac.in/_files/ugd/bb8ca0_e039b1b797be4752ade3bde7f26893c1.pdf" target = "_blank">11</a></td>
                    <td><a href="https://www.umit.ac.in/_files/ugd/bb8ca0_2659a694a5574e3b8c426938007fb7e0.pdf" target = "_blank">109</a></td>
                    <td>8 LPA</td>
                </tr>
                <tr>
                    <td>2018-19</td>
                    <td><a href="https://www.umit.ac.in/_files/ugd/bb8ca0_81545741ec1247538f7867483f963bf8.pdf" target = "_blank">7</a></td>
                    <td><a href="https://www.umit.ac.in/_files/ugd/bb8ca0_b5a9e43bc93f4b96ab521a8fcf34e20b.pdf" target = "_blank">102</a></td>
                    <td>7 LPA</td>
                </tr>
                <tr>
                    <td>2017-18</td>
                    <td><a href="https://www.umit.ac.in/_files/ugd/bb8ca0_174f82a312a948658e37f759a6c301f1.pdf" target = "_blank">6</a></td>
                    <td><a href="https://www.umit.ac.in/_files/ugd/bb8ca0_bc3cc21e6ab34c63bda6925f508f64cf.pdf" target = "_blank">75</a></td>
                    <td>7 LPA</td>
                </tr>
            </tbody>
        </table>
...
<div class="container" style="margin-top: 10px;">
    <!-- Circular Statistics -->'
    <h1 style="color: black;">Year-wise Placements</h1>
    <hr style="border-top: 2px solid black; margin-bottom: 20px; font-weight: bold;">
        <div class="circle-stats-container" id="circleStatsContainer">
        <canvas id="placementChart" width="600" height="400"></canvas>
            <!-- Dynamically Generated Circular Statistics Will be Placed Here -->
        </div>
</div>
</div>

<p>
                        <a href="visual5.php" style="margin-left: 10%;">More</a>
                    </p>

<div> <?php include_once 'bot.php'; ?>

            ...
            <div class="menuPage">
                <div class="resMainmenu">
                    ...
                    <ul class="navMenu">
                                ...
                                class="active" title="Social-Media">
                                                                Social-Media
                                                                 </a>
                                                    </li>
...
<body>
    ...
    <section>
        <div class="container"><h1 >Alumnis Of UMIT</h1>
            <div class="row">
                <div class="col-lg-12">

                <div class='sk-ww-linkedin-page-post' data-embed-id='25384177'></div><script src='https://widgets.sociablekit.com/linkedin-page-posts/widget.js' async defer></script>

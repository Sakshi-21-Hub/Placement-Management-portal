...
<head>
    ...
    <style>
        ...
        .alumni-card {
            width: 200px;
            padding: 20px;
            border: 2px solid #000; /* Changed to bold border */
            border-radius: 8px;
            box-shadow: 0px 8px 16px rgba(0, 0, 0, 0.2); /* Increased shadow */
            scroll-snap-align: start;
            flex: 0 0 auto;
            animation: slideLeft 3s infinite alternate; /* Animation added */
        }

        .alumni-card img {
            width: 100px; /* Adjust as per your requirements */
            height: 100px; /* Ensure the same height as width */
            border-radius: 50%;
      ...
      /* Add margin */
        ...
        .college-img-container img {
            width: 100%;
            transition: transform 0.5s ease;
        }

        .college-img-container:hover img {
            transform: scale(1.1);
        }
        .section {
            margin-bottom: 40px;
...
<section id="users" class="users">  
    ...
    <div class="container aos-init aos-animate" data-aos="fade-up">
        ...
        <div class="alumni-container">
            <?php
            // Sample alumni data - You can fetch this from your database
            $alumni = array(
                array("name" => "Viashnavi Desai", "batch" => "2021", "image" => "vaishnavi_desai.png"),
                array("name" => "Swathi Shetty", "batch" => "2016", "image" => "swathi_shetty.png"),
                array("name" => "Vandita Rai", "batch" => "2021", "image" => "vandita_rai.png"),
                array("name" => "Irit Khushwala", "batch" => "2023", "image" => "irit_khushwaha.png"),
                array("name" => "Dhurva Kamble", "batch" => "2023", "image" => "dhurva_kamble.png"),
                array("name" => "Shruti Kure", "batch" => "2022", "image" => "shruti_kure.png"),
                array("name" => "Gauraja Deo", "batch" => "2016", "image" => "login (2).jpeg"),
                array("name" => "Shikha Akhouri", "batch" => "2016", "image" => "login (2).jpeg"),
                array("name" => "Jyoti Birardar", "batch" => "2016", "image" => "login (2).jpeg"),
                array("name" => "Satabdi Paul", "batch" => "2016", "image" => "login (2).jpeg"),
                array("name" => "Mahima Raina", "batch" => "2016", "image" => "login (2).jpeg"),
                array("name" => "Sakshi Sinha", "batch" => "2016", "image" => "login (2).jpeg")
            );

            // Loop through each alumni and create a card
            foreach ($alumni as $person) {
                echo '<div class="alumni-card">';
                echo '<img src="images/' . $person["image"] . '" alt="' . $person["name"] . '">';
                echo '<h3>' . $person["name"] . '</h3>';
                echo '<p>Batch: ' . $person["batch"] . '</p>';
                echo '</div>';
            }
            ?>
        </div>
    ...
    <div class = "">
    <h1 class="alumni-heading">Alumni Map</h1>
    <div style="margin-left: 10px; margin-top : 50px;">
    <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1ZfmbrTeF8K5fgYBtJLr0NfqMwGDjF2M&ehbc=2E312F" margin left = "105px" width="1500" height="490"></iframe>    </section>

    </div>
    </div>

<script>
    // JavaScript for Continuous Carousel
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="footer-box">
                                <a class="footer-logo" href="in" title="UMIT"><img

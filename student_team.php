            ...
            <div class="menuPage">
                <div class="resMainmenu">
                    ...
                    <ul class="navMenu">
                                ...
                                class="active" title="Placement Coordinators">
...
<div class="container">
        <div class="section">
            <h1>Student Team - Training and Placement Cell</h1>
            <div class="table-responsive">
                <div id="team_tpc_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
<!--                 
                    <div class="col-sm-6">
                        <div id="team_tpc_filter" class="dataTables_filter">
                            <label>Search:<input id="table-search-input" type="search" class="form-control input-sm" placeholder="" aria-controls="team_tpc"></label>
                        </div> -->
                    </div>
                    <table class="table" id="team_tpc">
                        <thead>
                            <tr>
                                <th>Student Name</th>
                                <th>Designation</th>
        ...
        <tr>
            ...
            <td>CE</td>
            <td>4th</td>
            <td>shaily@gmail.com</td>
            <td>+91 74003 90238</td>
        </tr>
        <tr>
                  <td>Archana Kalathiya</td>
            <td>Vice President</td>
            <td>CST</td>
            <td>4Tth</td>
            <td>archana@gmail.com</td>
            <td>+91 91367 19299</td>
        </tr>
        <tr>
          
            <td>Shirisha Dumpeti</td>
            <td>Secretary</td>
            <td>IT</td>
            <td>4th</td>
            <td>shirisha.d@gmail.com</td>
            <td>+91 80970 97678</td>
        </tr>
        <tr>

...
<body>
    <?php 
            ...
            if (isset($_POST['signup'])) {
                ...
                if ($pwd1 == $pwd2) {
                    $sql = "insert into adminlogin(uname, pwd, fname, lname, email,emp_id, phone, secque, secans) values('$uname', '$hashed_password', '$fname', '$lname', '$email','$emp_id', '$phone', '$secque', '$secans');";

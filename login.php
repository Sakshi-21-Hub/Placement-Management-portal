		...
		<div class="container">
			<div class="row">
				<div class="col-lg-5" style="margin-top: 50px;">
					<img id="img2" src="images/login.jpeg" width="300px" style="position: absolute;  z-index: 1; margin-left: 120%; margin-top: 10px;">

					<h1 class="form-row justify-content-center">Sign in to your Account</h1> <br>
							...
							<div class="center one">
								<div class="form-row">
									<div class="form-group" style="width: 400px;">
										<label class="mb-3" for="cname">Username</label>
										<input type="text" class="form-control" id="cname" name="uname" style="width: 100%;" required>
								...
								<div class="form-row">
									<div class="form-group" style="width: 400px;">
										<label class="mb-3" for="cid">Password</label>
										<input type="password" class="form-control" id="cid" name="pwd1" style="width: 100%;" required>
										<div class="invalid-feedback">
								...
								<div class="form-row mb-3">
									<div class="form-group">
										<button type="submit" class="btn" name="login" style="width: 100%; margin-left: 100px; color: white;
									font-weight: bold; background: linear-gradient(to left, #2F07FF, #0987FF);">Login</button>
									</div>
								</div>
								<div class="form-group mb-3 text-center">
									<a href="forgot.php" class="btn text-dark" style="margin-left: -180px;">Forgot Password?</a>
								</div>
								<div class="form-group text-center">
									<a href="allregister.php" class="btn btn-light btn-sm" style="margin-left: -180px; margin-bottom: 50px;"><u>Don't have an account?, Sign Up!</u></a>
								</div>
							</div>
						</div>
					</form>
				...
				<div class="col-lg-7 text-center">
					<!-- <img src="images/jump1.png" width="80%" class="img-fluid login-img" alt="" > -->
...
Mumbai 400049
                                ...
                                <div class="social-media-footer">
                                               <a href="https://www.facebook.com/sameer.gov.in" target="_blank" title="facebook"><i
                                            class="fa fa-facebook-f"></i></a>
                                                                        <a href="https://twitter.com/SAMEER_RnD" target="_blank" title="twitter"><i
                                            class="fa fa-twitter"></i></a>
                                                                        <a href="#" target="_blank" title="Instagram"><i
                                            class="fa fa-instagram"></i></a>
                                                                        <a href="https://www.linkedin.com/company/sameer-r&amp;d-of-dit-govt-of-india-/mycompany/" target="_blank" title="Linkedin"><i
                        ...
                        <div class="col-lg-2">
                            <div class="footer-box">
                                            ...
                                            Home</a></li>
                                                                                                                                                                                                                        <li><a href="https://www.aicte-india.org/" target="_self" title="AICTE">
                                            AICTE</a></li>
                                                                                                                                                                                                                        <li><a href="https://sndt.ac.in/" target="_self" title="Tenders">
                                            SNDT</a></li>
                                                                                                                                                                                                                        <li><a href="alumini.php" target="_self" title="Alumini">
                                            Alumni</a></li>
                                                                                                                                                                                                                        <li><a href="https://dte.maharashtra.gov.in/" target="_self" title="DTE">
                                            DTE</a></li>

...
<head>
    ...
    <title>UMIT Training and Placement Cell Web - Internship Policy</title>
...
<body>
    ...
    <h1>Internship Policy</h1>
 <div class="clearfix " style= "background-color: white">
 <ol><ol start="1">
    <li>1) The Undergraduate Students are required to undergo summer training for a duration of a minimum of 6 weeks during the summer vacation after completing 6 semesters for B.Tech. students and 6/8 semesters for IDD students. M.Tech/M.Pharma students can proceed for 2-semester internships after completing their first year.</li><br>
    <li>2) The company shall fill up the Internship Announcement Form (IAF) and submit it to the Training and Placement Cell (TPC) as an e-mail attachment to tpo@iitbhu.ac.in or in the form of a hard copy. The IAF serves to introduce the candidates to the company's internship profile, requirements, etc.</li><br>
    <li>3) The IAF is electronically broadcasted to the concerned students along with all the other relevant information furnished by the company.</li><br>
    <li>4) The company can ask for the resumes of interested students and has the liberty to shortlist them at any stage of the intern selection process.</li><br>
    <li>5) The company will be allotted dates (<a href="calendar.pdf">Placement Calendar</a>) for conducting Pre–Placement Talk (PPT)/Written Test/Online Test, with a request to confirm the same by a specified date. On failing to do so, the allotted date may be given to other companies upon their requests. Requests for any change in the date can be entertained subject to availability.</li><br>
    <li>6) The company visits the campus on scheduled dates and conducts the Written/Online Test/GD/Interview as part of their intern selection procedure during the assigned time frame. Internship offers are not to be disclosed to the students, and the final selection results are to be submitted to the TPC in a sealed envelope or communicated by email. Students with multiple offers will generally be required to finalize their option and inform the TPC by 12 noon of the next working day. The students’ choice would be informed to the concerned companies. However, in some cases where the company urgently needs this information, the concerned students will be informed electronically to exercise their option by the specified time. To ensure safety against dropout, the company is suggested to prepare a list of students, in order of their merit, who can be kept waitlisted. Any dropout from the main list will enable the movement of waitlisted candidates to the list of selected candidates, and the company will be informed of the same.</li><br>
    <li>7) The Institute follows a "One Student One Internship" policy.</li><br>
    <li>8) The company is required to send offer letters to the TPC, which will then hand them over to the concerned students. Such letters, hard or soft copy, are expected to reach the TPC before March 31, 2024.</li><br>
    <li>9) On successful completion of Internships, companies may offer PPOs (Pre-Placement Offers) to the students. PPOs offered by the company have to be intimated to the TPC. However, the student is at the liberty of accepting or rejecting the PPO. The concerned student has to express his/her choice to the TPC within two working days of receiving the PPO. If he/she accepts the PPO offer, then he/she will not be allowed to participate in any further on-campus placement activity. As an exception to this, a student with a PPO can appear for the placement procedure of a PSU.</li><br>
    <li>10) In the best interest of the company, it is advised to send the list of PPOs as early as possible, preferably by the end of October of the next academic session, to prevent potential students from participating in any on-campus placement activity.</li><br>
</ol>

                <a class="btn btn-md btn-primary" style="margin-left: 400px;" href="internship_policy_company.pdf" target="_blank">Click here to Download the aforementioned Internship Policy (as PDF)</a><br><br><br>
                <p></p>
 </div>

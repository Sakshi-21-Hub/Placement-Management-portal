...
<head>
    ...
    <title>UMIT  training and placement cell web - Registration</title>
...
<body>
    <?php 
            ...
            if (isset($_POST['signup'])) {
                ...
                if ($pwd1 == $pwd2) {
							$sql = "insert into company(uname,companyname, pwd, managerfname, managerlname, address, email, phone, website, secque, secans) values('$uname','$companyname', '$hashed_password', '$managerfname', '$managerlname', '$address','$email', '$phone', '$website','$secque', '$secans');";
                ...
                <div class="container" style="margin-top: 130px; margin-left: 270px;">
                    ...
                    <div class="alert alert-success" role="alert" style="width: 600px; margin-left: 300px;">
                      ...
                      <hr>
                      <p class="mb-0"><a href="login.php"><b>Login</b> to explore more.</p>
                    </div>
                </div>
                    <?php
                } else {
        ...
        <img src="images/404b.png" id="img1" style="position: fixed; margin-top: 140px;" width="500px">
                <div class="container" style="margin-top: 130px; margin-left: 270px;">
                    ...
                    <div class="alert alert-danger" role="alert" style="width: 600px; margin-left: 300px;">
                      ...
                      <hr>
                      <a href="aregister.php" class="alert-link"><b>Get back to register</a>
                    </div>
                </div>
                <?php
                } 

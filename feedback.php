...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $email = $_POST["email"];
    $phone = $_POST["phone"];
    $message = $_POST["notes"]; // Assuming this corresponds to the 'feedback' or 'query' message

    if ($type === "Query") {
        $sql = "INSERT INTO query (name, email, phone, query) VALUES (?, ?, ?, ?)";
    } elseif ($type === "Feedback") {
        $sql = "INSERT INTO feedback (name, email, phone, feedback) VALUES (?, ?, ?, ?)";
    }
    ...
    if ($stmt->execute()) {
        ?>
        <script>
        alert("Your Query/Feedback has been Successfully Submitted");
...
<section class="py-5">
      ...
      <div class="Main_page">
                <h2 class="h1 font-weight-800 mb-3 mb-md-4">
                 Feedback / Query
                 
        </h2>
        
        <div class="row row-gap-5 align-items-inherit">
          <div class="col-12 col-md-6 col-lg-4 contact_details_wrap d-flex flex-column row-gap-5">
            <div class="contact_details_row d-flex">
              <span class="contact_details_icon">
                <img src="https://sameer.gov.in/public/website/images/conticon1.png" alt="Address">
              </span>
              <div class="contact_details">
                              <h5 class="h4 fw-600 text-primaary mb-1">Address</h5>
                <p class="h5 fw-300 mb-0">Training & Placement Cell,
...
Mumbai - 400049
            ...
            <div class="contact_details_row d-flex">
              <span class="contact_details_icon">
                <img src="https://sameer.gov.in/public/website/images/conticon2.png" alt="Address">
              </span>
              <div class="contact_details">
                <h5 class="h4 fw-600 text-primaary mb-1"> Phone </h5>
                <p class="h5 fw-300 mb-0">
                  <a href="tel:9820161954">+91 9820161954</a>
                </p>
              </div>
            </div>
            <div class="contact_details_row d-flex">
              <span class="contact_details_icon">
                <img src="https://sameer.gov.in/public/website/images/conticon3.png" alt="Address">
              </span>
              <div class="contact_details">
                <h5 class="h4 fw-600 text-primaary mb-1"> Email  </h5>
                <p class="h5 fw-300 mb-0">
          ...
          <div class="col-12 col-md-6 col-lg-8">
            <div class="cont_form_right_wrapper p-3 p-md-4 border">
              <h3 class="fw-700 mb-3 mb-md-4 text-secondary"> Send us a message!  </h3>
              <form method="POST" action="" accept-charset="UTF-8" id="createForm" autocomplete="off" class="form-row needs-validation" enctype="multipart/form-data">
                <input name="id" type="hidden">
                 <input type="hidden" name="_token" value="AlQ1Qh5LFQYtttS4zdV2g5yCuEf8OKaXqIrurWXK">                <div class="col-12 col-sm-6">
                  <div class="form-group">
                                    <select class="form-control" id="type" required="required" name="type"><option selected="selected" value="">Select  Type</option><option value="Feedback">Feedback</option><option value="Query">Query</option></select>              
                  </div>
                </div>     
                <div class="col-12 col-sm-6">
                  <div class="form-group">
                    <input type="text" class="form-control" name="name" id="validationCustom01" placeholder="Full Name" value=""  required>
                    <div class="invalid-feedback">Please enter your name.</div>
                  </div>
                </div>
                <div class="col-12 col-sm-6">
                  <div class="form-group">
                    <input type="email" class="form-control" name="email" id="validationCustom02" value="" placeholder="Email Address"
                      required>
                ...
                <div class="col-12 col-sm-6">
                  <div class="form-group">
                    <input type="text" class="form-control" name="phone" id="validationCustom03" value="" onkeypress="allowNumbersOnly(event)"placeholder="Phone number" required maxlength="10" pattern="[0-9]{10}" >
                    <div class="invalid-feedback">Please enter phone number.</div>
                  </div>
                </div>
                <div class="col-12">
                  <div class="form-group">
                    <textarea id="notes" class="form-control" name="notes" placeholder="Enter your Message" maxlength="255" required></textarea>
                  </div>
                </div>
               
                <div class="col-12 mt-4 text-center">
                  <button class="more-btn orrange rounded" type="submit">
                   Submit                   </button>
                </div>
              </form>
            </div>
    ...
    <script src="https://sameer.gov.in/public/vendor/jquery/jquery.min.js"></script>

...
<body>
        ...
        <div class="container">
            ...
            <div>
                ...
                if (isset($_POST['signup'])) {
                    ...
                    echo $companyname;
                    // if ($pwd1 == $pwd2) {
                    //  $sql = "insert into company(companyname, pwd, managerfname, managerlname, address, email, phone, website, secque, secans) values('$companyname', '$pwd1', '$managerfname', '$managerlname', '$address','$email', '$phone', '$website','$secque', '$secans');";
                    //  mysqli_query($conn, $sql);
                    // }
                }
                ?>
            </div>
            <form action="cregister.inc.php" autocomplete="off" method="POST">
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="uname" name="uname" required pattern=".{4,}">
                ...
                Enter a Username (at least 4 characters)
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="companyname" name="companyname" required pattern="^[A-Za-z0-9\-]{1,}$">
                        <div class="invalid-feedback">
                            Enter Company Name
                        </div>
                    </div>
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="managerfname" name="managerfname" required pattern="[A-Za-z]{1,}">
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="managerlname" name="managerlname" required pattern="[A-Za-z]{1,}">
                        <div class="invalid-feedback">
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="url" class="form-control" id="website" name="website" required pattern="(https?://)?(www\.)?.+">
        ...
        <div class="invalid-feedback">Enter Address</div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="secans" name="secans" required>
                        <div class="invalid-feedback">
                            Enter Answer
                        </div>
                    </div>
                </div>
                <button type="submit" class="btn btn-dark btn-block" name="signup" style=" color: white ; font-weight: bold; width:100% ;background: linear-gradient(to left, #4181ED, #3F4261);">SignUp</button>
            </form>
        </div>
    </section>

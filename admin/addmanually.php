            ...
            <div class="menuPage">
                <div class="resMainmenu">
                    ...
                    <ul class="navMenu">
                                ...
                                class="faIcon" title="company">
                                                                Company
                                                                 <i class="fa fa-caret-down"></i>  </a>
                                                        <ul class="dropMenu">
                                                                                               
                                                                                                                                <li><a href="addcompanies.php" title="Add Company">
                                                                                Add Company
                                        </a></li>

                                        <li><a href="viewcmp.php" title="View Company">
                                                                                View Company
                                        </a></li>
                                                                                            </ul>
                                                    </li>
                                                    <li class="menuHover"><a href="#"
                                class="faIcon" title="job">
                                                                Job
                                                                 <i class="fa fa-caret-down"></i>  </a>
                                                        <ul class="dropMenu">
                                                                                               
                                                                                                                                <li><a href="addjob.php" title="Add Job">
                                                                                Add Job
                                        </a></li>

                                        <li><a href="viewjob.php" title="View Job">
                                                                                View Job
                                        </a></li>
                                                                                            </ul>
                                                    </li>    
                                                    ...
                                                    <li class="menuHover"><a href="#"
                                class="active" title="Student">
                                                                Student
                                                                 <i class="fa fa-caret-down"></i>  </a>
                                                        <ul class="dropMenu">
                                                                                               
                                                                                                                                <li><a href="addstudents.php" class="active" title="Add Student">
                                                                                Add Student
                                        </a></li>

                                        <li><a href="viewstudents.php" title="View Student">
                                                                                View Student
                                        </a></li>
                                                                                        
                                                

                                                    <li><a href="studentsapplication.php" title="Companies applied">
                                                                                Companies Applied
                                        </a></li>
                                                                                                                

                                                    
                                                    <li><a href="selectedstudents.php" title="Selected Students">
                                                                                Selected Students
                                        </a></li>
                                                                                            </ul>
                                                    </li>    
                                                    ...
                                                    <li class="menuHover"><a href="#"
                                class="faIcon" title="schedule">
                                                                Schedule
                                                                 <i class="fa fa-caret-down"></i>  </a>
                                                        <ul class="dropMenu">
                                                                                               
                                                                                                                                <li><a href="postschedule.php" title="Post Schedule">
                                                                                Post Schedule
                                        </a></li>

                                        <li><a href="viewschedule.php" title="View Schedule">
                                                                                View Schedule
                                        </a></li>
                                                                                            </ul>
                                                    </li>
                                                    ...
                                                    <li class="menuHover"><a href="#"
                                class="faIcon" title="Study Material">
                                                                Study Material
                                                                 <i class="fa fa-caret-down"></i>  </a>
                                                        <ul class="dropMenu">
                                                                                               
                                                                                                                                <li><a href="poststudymaterial.php" title="Add study material">
                                                                                Add Study Material
                                        </a></li>

                                        <li><a href="viewstudymaterial.php" title="View study material">
                                                                                View Study Material
                                        </a></li>
                                                                                            </ul>
                                                    </li>
                                                    ...
                                                    <li class="menuHover"><a href="#"
                                class="faIcon" title="query">
                                                                Query
                                                                 <i class="fa fa-caret-down"></i>  </a>
                                                        <ul class="dropMenu">
                                                                                               
                                                                                                                                <li><a href="query.php" title="Answer Query">
                                                                                Answer Query
                                        </a></li>
...
<body>
    <section>
        <div class="container">
        <h2 class="text-center mb-5"style="margin-top:1px; color:black;">Add Students Deatils</h2>
        <form action="php/addstud.inc.php" method="POST">
            <!-- Hidden inputs to disable autofill -->
        ...
        <div class="center mt-4">
             <div class="form-row ">
                        ...
                        <input type="text" class="form-control" id="uname" name="uname" placeholder="Enter username" required pattern=".{4,}">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="prn" name="prn" placeholder="PRN"required pattern="^\d{16}$">
                        <div class="invalid-feedback">
                            Enter PNR Number
                        </div>
                    </div>
                ...
                <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="fname" name="fname"  required pattern="[A-Za-z]{1,}">
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="lname" name="lname" required pattern="[A-Za-z]{1,}">
                        <div class="invalid-feedback">
                            Enter Last Name</div>
                    </div>
        </div>
        ...
        <div class="form-row">
                    ...
                    <div class="invalid-feedback">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="phone" class="form-control" id="phone" name="phone"placeholder="Enter phone" required pattern="^\d{10}$">
                    <div class="invalid-feedback">
...
<select style="width: 100%;" class="custom-select" name="yop" id="yop"  required>
</select>
...
<script>
    ...
    var selectElement = document.getElementById('yop');

    // Loop to generate options dynamically for the next 10 years
    for (var i = 0; i < 10; i++) {
        // Create an option element
        var option = document.createElement('option');
        
        // Calculate the year for this option
...
<div class="form-row ">
                        <div class="col-md-6 mb-3">
                            <label for="percentage">Btech Percentage</label>
                            <input type="text" class="form-control" id="percentage" name="percentage"  required pattern="\d{1,2}(\.\d{1,2})?">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="ssc">SSC Percentage</label>
                            <input type="text" class="form-control" id="ssc" name="ssc"   required pattern="\d{1,2}(\.\d{1,2})?">
                        </div>
</div>
...
<div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="hsc" name="hsc"   required pattern="\d{1,2}(\.\d{1,2})?">
                        </div>
                ...
                <!-- Add other form fields here -->
                    ...
                    <div id="password-special-char"></div>
                    <div id="password-capital-letter"></div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="invalid-feedback">
                        ...
                        <div class="col-md-6 mb-3">
                    <label for="secque">Security Question</label>
                    <select class="form-control" id="secque" name="secque" required>
                    <option value="" disabled selected>Select a security question</option>

                        <option>Which is your favourite food?</option>
                        <option>Which was your first phone?</option>
...
<div class="form-row ">
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control" id="secans" name="secans" required pattern=".{1,}">
                    <div class="invalid-feedback">
                        Enter Answer
                    </div>
                </div>
                ...
                <button type="submit" class="btn btn-dark btn-block" name="add" style="color: white; font-weight: bold; width: 65%; background: linear-gradient(to left, #4181ED, #3F4261);">Submit</button>
                </div>
            </div>
        </form>
    </div>
	...
	<script>
		$(document).ready(function() {
			$('#pwd1').on('input', function() {
				...
				var minLength = 8; // Change this to your desired minimum length
				if (password.length >= minLength) {
					$('#password-length').html('<span style="color:green;">Password length is sufficient</span>');
				} else {
					$('#password-length').html('<span style="color:red;">Password should be at least ' + minLength + ' characters long</span>');
				}

				// Special character check
				var containsSpecialChar = /[!@#$%^&*(),.?":{}|<>]/.test(password);
				if (containsSpecialChar) {
					$('#password-special-char').html('<span style="color:green;">Password contains special character(s)</span>');
				} else {
					$('#password-special-char').html('<span style="color:red;">Password should contain at least one special character</span>');
				}

				// Capital letter check
				var containsCapitalLetter = /[A-Z]/.test(password);
				if (containsCapitalLetter) {
					$('#password-capital-letter').html('<span style="color:green;">Password contains at least one capital letter</span>');
				} else {
					$('#password-capital-letter').html('<span style="color:red;">Password should contain at least one capital letter</span>');
				}

				// Number check
				var containsNumber = /\d/.test(password);
				if (containsNumber) {
					$('#password-number').html('<span style="color:green;">Password contains number(s)</span>');
				} else {
					$('#password-number').html('<span style="color:red;">Password should contain at least one number</span>');
				}
			});

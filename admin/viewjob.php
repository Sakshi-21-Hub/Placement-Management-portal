            ...
            if($rescheck > 0) {
              while ($row = mysqli_fetch_assoc($res)) {
                  ...
                  echo "<td>" . $seq . "</td>";
                    ...
                    <td>
                      <a href="editjob.php?edit=<?php echo $row['id']; ?>" class="btn btn-sm" name="deleteloc"><i class="fas fa-pen" style="color: #3498DB;"></i></a>
                      <a href="php/crud.php?delete3=<?php echo $row['id']; ?>" class="btn btn-sm" name="deleteloc"><i class="fas fa-trash" style="color: red;"></i></a>
                    </td>
                    <?php
                        $seq += 1;
                  echo '</tr>';

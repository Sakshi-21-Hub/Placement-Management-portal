                    ...
                    <ul class="navMenu">
                                ...
                                class="faIcon" title="schedule">
                                        ...
                                        <li><a href="viewschedule.php" title="View Schedule">
                                                    ...
                                                    <li class="menuHover"><a href="#"
                                class="active" title="Study Material">
                                                                Study Material
                                                                 <i class="fa fa-caret-down"></i>  </a>
                                                        <ul class="dropMenu">
                                        ...
                                        <li><a href="viewstudymaterial.php" class="active" title="View study material">
                                                                                View Study Material
                                        </a></li>
                                                                                            </ul>
                                                    </li>
...
<body>
    <section>
        <div class="container">
        <h2 class="text-center mb-5"style="margin-top:1px; color:black;">Update Study Material</h2>
            <form action="php/poststudymaterial.inc.php" method="POST" style="margin-left:125px;width:140%; ">
    ...
    <input type="hidden" id="aid" name="id" value="<?php echo $row['id']; ?>">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="file_url" name="file_url" value="<?php echo $row['file_url']; ?>"equired pattern="(https?://)?(www\.)?.+">
        <div class="invalid-feedback">Enter a Valid Website URL</div>
                        ...
                        ?>
                        <button type="submit" class="btn btn-primary" name="update" style=" margin-top: 20px;color: white; font-weight: bold; background: linear-gradient(to left, #4181ED, #3F4261);">Update Study Material</button>
                    </div>
                </div>
            </form>
        </div>

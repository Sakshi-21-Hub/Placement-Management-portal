...
<section>
    ...
    <div class="col-lg-10" style="text-align: center;">
        <!-- <h2>Our Services</h2> -->
        <div class="button-container row" style="display: flex; justify-content: center; align-items: center; flex-wrap: wrap; gap: 10px; padding: 20px;">

        <div class="col d-flex justify-content-center" style="padding: 10px;">
    <a href="aprofile.php" class="navy-button btn btn-primary" style="width: 200px; height: 100px; line-height: 100px; display: flex; justify-content: center; align-items: center; text-align: center;">Profile</a>
</div>

            <div class="col d-flex justify-content-center" style="padding: 10px;">
                <a href="addadmins.php" class="navy-button btn btn-primary" style="width: 200px; height:100px; line-height: 100px; display: flex; justify-content: center; align-items: center; text-align: center;">Add Admin</a>
            </div>
            <div class="col d-flex justify-content-center" style="padding: 10px;">
                <a href="viewadmin.php" class="navy-button btn btn-primary" style="width: 200px; height:100px; line-height: 100px; display: flex; justify-content: center; align-items: center; text-align: center;">View Admin</a>
            </div>
            <div class="col d-flex justify-content-center" style="padding: 10px;">
                <a href="changepass.php" class="navy-button btn btn-primary" style="width: 200px; height:100px; line-height: 100px; display: flex; justify-content: center; align-items: center; text-align: center;">Change Password</a>
            </div>
            <div class="col d-flex justify-content-center" style="padding: 10px;">
                <a href="../login.php" class="navy-button btn btn-primary" style="width: 200px; height:100px; line-height: 100px; display: flex; justify-content: center; align-items: center; text-align: center;">Logout</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h2 class="service-heading" style="margin-top: 20px">Our Services</h2>
                    <div class="services-container">
                        <div class="service-box" style="background-color: #f8b400;">
                            <h3>Internship</h3>
                            <p>Internship and Training Opportunities</p>
                        </div>
                        <div class="service-box" style="background-color: #7d3cff;">
                            <h3>Placement Assistance</h3>
                            <p>Coordinating campus recruitment drives and job fairs.</p>
                        </div>
                        <div class="service-box" style="background-color: #00bfa5;">
                            <h3>Skill Development</h3>
                            <p>Training sessions to enhance students' technical and soft skills.</p>
                        </div>
                        <div class="service-box" style="background-color: #ff5252;">
                            <h3>Alumni Relations</h3>
                            <p>Alumni networking events and career guidance sessions.</p>
                        </div>
                        <div class="service-box" style="background-color: #9e9e9e;">
                            <h3>Career Placement Support</h3>
                            <p>Providing support services to ensure a smooth transition for students from campus to corporate life</p>
                        </div>
                        <div class="service-box" style="background-color: #43a047;">
                            <h3>Career Counseling and Guidance</h3>
                            <p>Providing career counseling services to students regarding job opportunities, career paths, and skill development.</p>
                        </div>
                    </div>
                </div>
            </div>

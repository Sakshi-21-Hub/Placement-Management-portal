                ...
                <div class="resMainmenu">
                    ...
                    <ul class="navMenu">
                                ...
                                class="active" title="schedule">
                                        ...
                                        <li><a href="viewschedule.php" class="active" title="View Schedule">
                                                                                View Schedule
                                        </a></li>
                                                                                            </ul>
                                                    </li>
...
<body>
    <section>
        <div class="container">
        <h2 class="text-center mb-5"style="margin-top:1px; color:black;">Update Schedule Details</h2>
            <form action="php/postschedule.inc.php" method="POST">
                <div class="row justify-content-center">
                    <div class="col-md-10" style="width:150%;" >
                        <?php
    ...
    <input type="hidden" id="aid" name="id" value="<?php echo $row['id']; ?>">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="companyname" name="companyname" value="<?php echo $row['companyname']; ?>" readonly>
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="form-group text-center">
                            <button type="submit" class="btn btn-primary" name="update" style="width:150%; margin-top: 20px;color: white; font-weight: bold; width: 65%; background: linear-gradient(to left, #4181ED, #3F4261);">Update Schedule Detalis</button>
                        </div>
                    </div>
                </div>
            </form>

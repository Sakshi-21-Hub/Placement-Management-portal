...
<body>
    ...
    <div class="container">
    <h1 class="form-row justify-content-center" style="margin-left: -200px; margin-top: 30px;">List of Admins</h1> <br>
<!-- <button type="button" onclick="admin/addadmins.php" class="btn" name="update" style="width: 250px; color: white; font-weight: bold; background: linear-gradient(to left, #4B83EA, #504EC2);">Add Admin </button> -->
<style>
                        .box {
                            padding: 1px;
                            border-radius: 2px;
     ...
     <table class="table table-hover table-borderless table-dark">
      ...
      <tbody>
        <tr>
          <?php
              $seq = 1;
            $sql = "SELECT * from adminlogin order by time DESC;";
              ...
              while ($row = mysqli_fetch_assoc($res)) {
                  ...
                  echo "<td>" . $seq . "</td>";
                   // echo '<td>'.$row['id'].'</td>';
                    ...
                    <td>
                      <a href="editadmin.php?edit=<?php echo $row['id']; ?>" class="btn btn-sm" name="deleteloc"><i class="fas fa-pen" style="color: #3498DB;"></i></a>
                      <a href="php/crud.php?delete7=<?php echo $row['id']; ?>" class="btn btn-sm" name="deleteloc"><i class="fas fa-trash" style="color: red;"></i></a>
                    </td>
                    <?php
                  echo '</tr>';
              }

...
?>  
    ...
    #placementTable tr:hover {
        ...
        .btn {
            width: 50%;
            background: linear-gradient(to right, #4181ED, #3F4261);
            color: white;
            padding: 12px;
            font-weight: bold;
            border: none;
        ...
        .btn:hover {
            background: linear-gradient(to right, #3F4261, #4181ED);
            transform: scale(1.05);
        }
    </style>
                    ...
                    ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="cname" name="uname" value="<?php echo $row['uname']; ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="website" name="fname" value="<?php echo $row['fname']; ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="website" name="lname" value="<?php echo $row['lname']; ?>" readonly>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="exampleInputEmail1">Phone</label>
                                <input type="text" class="form-control" id="website" name="phone" value="<?php echo $row['phone']; ?>" readonly>
                        </div>
                        </div>
                            ...
                            <div class="form-group col-md-15 mb-3">
                                ...
                                <input type="text" class="form-control" id="website" name="email" value="<?php echo $row['email']; ?>" readonly>
                        </div>
                        
                                <div class="form-row justify-content-center">
                     <button type="submit" class="btn col-md-12 mb-3" name="edit"  style=" color: white;
                         font-weight: bold; margin-top: 30px;  background: linear-gradient(to left, #4181ED, #3F4261);">Edit Profile</button>
                 </div> <br> <br>
                 </div> 
                        </div>
                 <?php

        ...
        <?php if (isset($_SESSION['username'])) : ?>
                    <div class="profile">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="aprofile.php"><i class="fas fa-user-cog"
                            ...
                            <a class="dropdown-item" href="editprofile.php"><i class="fas fa-user-cog"
                                    ...
                                    <a class="dropdown-item" href="addadmins.php"><i class="fas fa-user-cog"
                                    style="font-size: 15px;"></i>&nbsp;Add admin</a>
                                    <a class="dropdown-item" href="viewadmin.php"><i class="fas fa-user-cog"
                                    style="font-size: 15px;"></i>&nbsp;View admin</a>
                            <a class="dropdown-item" href="changepass.php"><i class="fas fa-pen"
                                    style="font-size: 15px;"></i>&nbsp;Change Password</a>
                            <div class="dropdown-divider-1"></div>

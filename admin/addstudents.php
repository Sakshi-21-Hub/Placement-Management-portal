...
<body>
<!-- <img src="../images/admins.png" width="600px" style="position: absolute; z-index: 1; margin-left: 30%; margin-top: 20%;"> -->
<div class="container content" style="margin-top: 40px;">
        <div class="row justify-content-center">
            <h1 class="col-12 text-center" style=" 
            text-align: center;
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 col-lg-6 text-center">
                <div class="button-container">
                    <a href="uploadcsv.php" class="navy-button">Upload Excel</a>
                    <a href="addmanually.php" class="navy-button">Add Data Manually</a>
                </div>
            </div>
        </div>
    </div>

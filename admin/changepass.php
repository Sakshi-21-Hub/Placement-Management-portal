     ...
     <div class="container">
         ...
         <form action="php/changepass.inc.php" method="POST">
             <div class="form-group">
                 ...
                 <div id="password-special-char" class="text-danger"></div>
                 <div id="password-capital-letter" class="text-danger"></div>
                 <div id="password-number" class="text-danger"></div>
             </div>
             <div class="form-group">
             ...
             <button type="submit" class="btn btn-primary btn-block" style="background: linear-gradient(to left, #4181ED, #3F4261);" name="change">Change Password</button>
         </form>
     </div>
         ...
         $(document).ready(function () {
             $('#pwd1').on('input', function () {
                 ...
                 if (password.length >= minLength) {
                     $('#password-length').html('<span class="text-success">Password length is sufficient</span>');
                 } else {
                     $('#password-length').html('<span>Password should be at least ' + minLength + ' characters long</span>');
                 }
 
                 // Special character check
                 var containsSpecialChar = /[!@#$%^&*(),.?":{}|<>]/.test(password);
                 if (containsSpecialChar) {
                     $('#password-special-char').html('<span class="text-success">Password contains special character(s)</span>');
                 } else {
                     $('#password-special-char').html('<span>Password should contain at least one special character</span>');
                 }
 
                 // Capital letter check
                 var containsCapitalLetter = /[A-Z]/.test(password);
                 if (containsCapitalLetter) {
                     $('#password-capital-letter').html('<span class="text-success">Password contains at least one capital letter</span>');
                 } else {
                     $('#password-capital-letter').html('<span>Password should contain at least one capital letter</span>');
                 }
 
                 // Number check
                 var containsNumber = /\d/.test(password);
                 if (containsNumber) {
                     $('#password-number').html('<span class="text-success">Password contains number(s)</span>');
                 } else {
                     $('#password-number').html('<span>Password should contain at least one number</span>');
                 }
             });
             ...
             $('#pwd2').on('input', function () {
                 ...
                 if (password1 === password2) {
                     ...
                     $('#password-match').html('<span>Passwords do not match</span>');
                 }
             });
         });
     </script>

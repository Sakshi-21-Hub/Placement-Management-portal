...
<body>
    <section>
        <div class="container">
        <h2 class="text-center mb-5"style="margin-top:1px; color:black;">Add Admin Details</h2>
        <form action="php/addadmins.inc.php" method="POST">
            ...
            <div class="form-row ">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="emp_id" name="emp_id" placeholder="Enter employee ID" required pattern="^[A-Za-z0-9\-]{1,}$">
                    <div class="invalid-feedback">
            ...
            <div class="form-row ">
                    ...
                    <input type="text" class="form-control" id="fname" name="fname" placeholder="Enter first name" required pattern="[A-Za-z]{1,}">
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="lname" name="lname" placeholder="Enter last name" required pattern="[A-Za-z]{1,}">
                    <div class="invalid-feedback">
            ...
            <div class="form-row ">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="phone" name="phone" placeholder="Enter phone" required pattern="^\d{10}$">
                    <div class="invalid-feedback">
	...
	<script>
		...
		(function() {
          ...
          <footer class="footer-wrap" style="margin-top: 100px;" >

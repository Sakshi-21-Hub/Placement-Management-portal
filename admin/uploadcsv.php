...
<main>
<body>
    <!-- <img src="../images/admins.png" width="600px" style="position: absolute; z-index: 1; margin-left: 52%; margin-top: 20%;"> -->
    ...
    <div class="content" style="margin-top: 40px; margin-left: -0px;">
        ...
        <form action="php/processimport.php" method="post" enctype="multipart/form-data">
            <label for="file">Choose CSV file:</label>
            <input type="file" name="file" id="file" accept=".csv">
            <button type="submit" style="margin-right: 550px;" name="submit">Import</button>
        </form>

        <form action="php/addstud.inc.php" method="POST"></form>
...
<footer class="footer-wrap"  style="margin-top: 500px;">

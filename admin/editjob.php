                ...
                <div class="resMainmenu">
                    ...
                    <ul class="navMenu">
                                ...
                                class="active" title="job">
                                        ...
                                        <li><a href="viewjob.php" class="active" title="View Job">
                                                                                View Job
                                        </a></li>
                                                                                            </ul>
                                                    </li>    
...
<div class="container">
        <div class="content">
            <h2 class="text-center" style="margin-top: 30px;">Update Job Detalis</h2> <br>
  
                <form action="php/addjob.inc.php" method="POST" >
    ...
    <input type="hidden" id="cid" name="id" value="<?php echo $row['id']; ?>">
                       ...
                       <div class="form-row ">
                        ...
                        <select class="form-control" id="jobtype" name="jobtype" required>
                            <option value="FTO" <?php echo ($row['jobtype'] == 'FTO') ? 'selected' : ''; ?>>FTO (Full Time)</option>
                            <option value="PPO" <?php echo ($row['jobtype'] == 'PPO') ? 'selected' : ''; ?>>PPO (Pre-Placement)</option>
                            <option value="internship" <?php echo ($row['jobtype'] == 'internship') ? 'selected' : ''; ?>>Internship</option>
                        </select>
                    </div>
                 
                        <div class="col-md-6 mb-3">
                        <label for="jobrole">Job Role</label>
                        <input type="text" class="form-control" id="jobrole" name="jobrole" value="<?php echo $row['jobrole']; ?>">
                    </div>
                      </div>
                    <div class="form-row ">
                        <div class="col-md-6 mb-3">
                        <label for="joblocation">Job Location</label>
                        <input type="text" class="form-control" id="joblocation" name="joblocation" value="<?php echo $row['joblocation']; ?>">
                    </div>
                    ...
                    <div class="form-group text-center">
                        <button type="submit" class="btn btn-custom" name="update" style="margin-top: 30px;color: white; font-weight: bold; width: 65%; background: linear-gradient(to left, #4181ED, #3F4261);">Update Job Detalis</button>
                    </div>
                    <?php
                            }
                        }

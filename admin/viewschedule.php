     ...
     <div class="table-responsive">
      ...
      <tbody>
        <tr>
          <?php  
           $seq = 1;
            $sql = "SELECT * from schedule order by time1 DESC;";
            ...
            if($rescheck > 0) {
              while ($row = mysqli_fetch_assoc($res)) {
                 ...
                 //   echo '<td>'.$row['id'].'</td>';
                    ...
                    <td>
                      <a href="editschedule.php?edit=<?php echo $row['id']; ?>" class="btn btn-sm" name="deleteloc"><i class="fas fa-pen" style="color: #3498DB;"></i></a>
                      <a href="php/crud.php?delete5=<?php echo $row['id']; ?>" class="btn btn-sm" name="deleteloc"><i class="fas fa-trash" style="color: red;"></i></a>
                    </td>
                    <?php
                  echo '</tr>';
              }

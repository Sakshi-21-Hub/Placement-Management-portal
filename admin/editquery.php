                    ...
                    <ul class="navMenu">
                                ...
                                class="faIcon" title="Study Material">
                                        ...
                                        <li><a href="viewstudymaterial.php" title="View study material">
                                                    ...
                                                    <li class="menuHover"><a href="#"
                                class="active" title="query">
                                                                Query
                                                                 <i class="fa fa-caret-down"></i>  </a>
                                                        <ul class="dropMenu">
                                                                                               
                                                                                                                                <li><a href="query.php" class="active" title="Answer Query">
                                                                                Answer Query
                                        </a></li>
...
<body>
    <section>
        <div class="container">
        <h2 class="text-center mb-5"style="margin-top:1px; color:black;">Answer Query</h2>
            <form action="php/editquery.inc.php" method="POST">
    ...
    <input type="hidden" id="cid" name="id" value="<?php echo $row['id']; ?>">
                        ...
                        <div class="col-md-12 mb-3">
                            <label>Query</label>
                            <input type="text" class="form-control" id="query" name="query" value="<?php echo $row['query']; ?>" readonly>
                        </div>
                        </div>
                        ...
                        ?>
                        <button type="submit" class="btn btn-primary" name="update" style="width:150%; margin-top: 20px;color: white; font-weight: bold; width: 65%; background: linear-gradient(to left, #4181ED, #3F4261);">Submit</button>
                    </div>
                </div>
            </form>
        </div>

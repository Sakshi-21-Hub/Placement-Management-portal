                    ...
                    <ul class="navMenu">
                                ...
                                class="active" title="Study Material">
                                                        ...
                                                        <ul class="dropMenu">
                                                                                                                                ...
                                                                                                                                <li><a href="poststudymaterial.php" class="active" title="Add study material">
                                                                                Add Study Material
                                        </a></li>
...
<body>
    <section>
        ...
        <h2 class="text-center mb-5"style="margin-top:1px; color:black;">Add Schedule Details</h2>
         <form action="php/poststudymaterial.inc.php" method="POST">
         ...
         <div class="form-row ">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="file_url" name="file_url" placeholder="File URL"equired pattern="(https?://)?(www\.)?.+">

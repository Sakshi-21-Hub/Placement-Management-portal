                    ...
                    <ul class="navMenu">
                                ...
                                class="active" title="Student">
                                        ...
                                        <li><a href="viewstudents.php" title="View Student">
                                                    ...
                                                    <li><a href="selectedstudents.php" class="active" title="Selected Students">
                                                                                Selected Students
                                        </a></li>
                                                                                            </ul>
                                                    </li>    
     ...
     <div class="table-responsive">
      ...
      <tbody>
        <tr>
          <?php
           $seq = 1;
            $sql = "SELECT * from applied where status='Selected' order by time DESC;";

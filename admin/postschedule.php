                    ...
                    <ul class="navMenu">
                                ...
                                class="active" title="schedule">
                                                        ...
                                                        <ul class="dropMenu">
                                                                                                                                ...
                                                                                                                                <li><a href="postschedule.php" class="active" title="Post Schedule">
                                                                                Post Schedule
                                        </a></li>
...
<body>
    <section>
        <div class="container">
        <h2 class="text-center mb-5"style="margin-top:1px; color:black;">Add Schedule Details</h2>
            <form action="mailer/postschedule.inc.php" method="POST">
            ...
            <div class="form-row ">
                        <div class="col-md-6 mb-3">
                            <label for="title">Title of Schedule</label>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control" id="cname" name="cname" required>
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    echo "<option value=''>No Companies</option>";
                                }
                                $conn->close();
                                ?>
                            </select>
            ...
            <div class="form-row ">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="url" name="url" placeholder="Link if available" required>
                        </div>
            </div> 
            <br>

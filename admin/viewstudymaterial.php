    ...
    <h1 class="form-row justify-content-center" style=" 
     ...
     <table class="table table-hover table-borderless table-dark">
      ...
      <tbody>
        <tr>
          <?php
            $sql = "SELECT * from study_materials order by time DESC;";
            $seq = 1;
            ...
            if($rescheck > 0) {
              while ($row = mysqli_fetch_assoc($res)) {
                  echo '<tr>';
                    ...
                    ?>
                    <td>
                    <a href="editstudymaterial.php?edit=<?php echo $row['id']; ?>" class="btn btn-sm" name="deleteloc"><i class="fas fa-pen" style="color: #3498DB;"></i></a>

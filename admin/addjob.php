                    ...
                    <ul class="navMenu">
                                ...
                                class="active" title="job">
                                                        ...
                                                        <ul class="dropMenu">
                                                                                                                                ...
                                                                                                                                <li><a href="addjob.php"  class="active"title="Add Job">
                                                                                Add Job
                                        </a></li>
...
<body>
 <section>
    <div class="container">
        <div class="content">
            <h2 class="text-center" style="margin-top: 30px;">Add Job Details</h2> <br>
            <form action="php/addjob.inc.php" method="POST">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-control" id="cname" name="cname" required>
                        ...
                        $sql = "SELECT companyname FROM company where status =  'active'";
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-control" id="jobtype" name="jobtype" required>
                        <option value="FTO">FTO (Full Time)</option>
                        <option value="PPO">PPO (Pre-Placement)</option>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="jobrole" name="jobrole" placeholder="Job Role" required>
                </div></div>
                <!-- Job Location -->
                <div class="form-row">
                <div class="col-md-6 mb-3">

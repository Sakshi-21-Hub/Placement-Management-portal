...
<body>
    <section>
        <div class="container">
        <h2 class="text-center mb-5"style="margin-top:1px; color:black;">Edit Student Profile</h2>
            <form action="php/edit.inc.php" method="POST">
                <div class="row">
                   
                    <?php
                    // Assuming you have already started the session somewhere in your code
                    $user = $_SESSION['username']; // Assuming you have the username stored in the session
                    ...
                    ?>
                        ...
                        <div class="col-md-6 mb-3">
                                <label for="cname">Admin Username</label>
                                <input type="text" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"class="form-control" id="cname" name="uname" value="<?php echo $row['uname']; ?>" >
                            </div>
                               </div>
                               <div class="form-row ">
                        <div class="col-md-6 mb-3">
                                <label for="cname">Employee Id</label>
                                <input type="text" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"class="form-control" id="emp_id" name="emp_id" value="<?php echo $row['emp_id']; ?>" >
                        </div>
                        <div class="col-md-6 mb-3">
                                <label for="website">First Name</label>
                                <input type="text" pattern="[a-z0-9.-]+" class="form-control" id="website" name="fname" value="<?php echo $row['fname']; ?>" >
                            </div>   
                        </div>
                            <div class="form-row ">
                        <div class="col-md-6 mb-3">
                                <label for="exampleInputEmail1">Last Name</label>
                                <input type="text" pattern="[a-z0-9.-]+" class="form-control" id="website" name="lname" value="<?php echo $row['lname']; ?>" >
                            </div>
                        
                        <div class="col-md-6 mb-3">
                                <label for="exampleInputEmail1">Phone</label>
                                <input type="text" pattern="^\d{10}$"class="form-control" id="website" name="phone" value="<?php echo $row['phone']; ?>" >
                        </div> </div>
                          
                            <div class="form-group col-md-15 mb-3">
                                <label for="website">Email</label>
                                <input type="text" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"class="form-control" id="website" name="email" value="<?php echo $row['email']; ?>" >
                            </div>
 ...
 <div class="form-row justify-content-center">
        <button type="submit" class="btn mb-3" name="edit" style="color: white; width:60%; font-weight: bold; background: linear-gradient(to left, #4181ED, #3F4261); ">Edit Profile</button>
    </div>

    <div class="form-row justify-content-center">
        <button class="btn mb-3" style="font-weight: bold; width: 70%; color: white; ">
        <a href="changepass.php" class="btn btn-secondary" style="width: 90%;">Change Password</a>
    </div>
   
    <div class="form-row justify-content-center">
    <button class="btn mb-3" style="font-weight: bold; width: 70%; color: white; ">
        <a href="aprofile.php" class="btn btn-secondary" style="width: 90%;">Back to Profile</a>
    </div>
    <br><br>

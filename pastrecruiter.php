...
<head>
    ...
    <title>UMIT Training and Placement Cell Web -Past recruiter</title>
...
<body>
    <h1>Past recruiter</h1>
 <div class="clearfix " style= "background-color: white">
<ul class="column_list">
    <li><strong>A: </strong> AAKASH Educational Institute, ACC CEMENT, ACCENTURE, ACCOLITE, ADANI, ADITYA BIRLA, ADIYTA BIRLA Chemical, ADOBE, AIRPRODUCT, AIRTEL, ALLEN CARRIER INSTITUTE, ALPHONSO, ALTAIR, AMAZON, AMBUJA CEMENT, AMDOCS, APPLIED MATERIAL, ARISTA NETWORK, ATCS, ATRENTA, AXSIOM, AXTRIA</li><br>
    <li><strong>B: </strong> BORL, BECHTEL, BEEHYV, BELZABAR, BHARAT DINAMICS, BHARAT FORGE, BOSCH, BPCL, BRILLIANCE CLASS, BROADCOM, BROWSERSTACK</li><br>
    <li><strong>C: </strong> CB&I, C-DOT, CERA, CGI, CNRS, CSRL, CV RAMAN INSTITUTE, CADENCE, CALDERYS, CAMPUS COMMUNITY, CAPGEMINI, CAPITAL DYNAMIC, CARBORUNDUM, CARRIER UTC, CATERPILLER, CBI, CDAC, CENTURY LINK, CEVENT, CISCO, CITI CORP, CITRIX, CLAVILENO CAPITAL, CMC, COAL INDIA LIMITED, CODENATION, COGNIZANT, CUMI MURUGAPPA, CVRS</li><br>
    <li><strong>D: </strong> DIT UNIVERSITY, DMT, DRDO, DE SHAW, DEVELOPMENT ALTERNATIVE, DINDAYAL PETROLEUM UNIVERSITY, DIRECTI, DOLCERA, DOVER TECH, DR REDDYS</li><br>
    <li><strong>E: </strong> E BAY, EMC, EXL, EATON, EDELWEISS, EDGEVERVE, EGIS INDIA, EMERSON, EPIC SYSTEMS, ERA GROUP, ESSAR, ET MEDIALABS, EVALUSETVE, EXL SERVICES</li><br>
    <li><strong>F: </strong> FACEBOOK, FIDELITY, FIJI NATIONAL UNIVERSITY, FIRE EYE, FLIPKART, FLIPKART GT, FLIPKART SDE, FORTITUDE, FRACTAL ANALYTICS, FREESCALE, FUTURES FIRST</li><br>
    <li><strong>G: </strong> GE DIGITAL, GALAXYE.SOLUTIONS, GALE PARTNERS, GALGOTIA UNIVERSITY, GEIPER, GENERAL MOTORS, GLA, GLOBAL ANALYTICS, GOLDMAN SACHS, GOOGLE, GOOGLE (US), GROFERS, GWYNNIEBEE</li><br>
    <li><strong>H: </strong> HCL, HIL, HPCL, HPE, HSBC, HUL, HZL, HAVELLS, HEAD OUT, HERO MOTER CORP, HINDALCO, HONDA, HOSPIRA, HRR JOHNSON</li><br>
    <li><strong>I: </strong> I NATUIX, IOCL, I QUANTI, I QUANTI INC, I-PAC, I-RUNWAY, IBM (GBS), IBM (IRL), IFFCO TOKIO, IMC-SEG, IMPETUS, INDIAN ARMY, INDIAN OIL, INDIAN RESOURCES LTD, INDUS INSIGHTS, INDUS VALLEY, INFOSYS, INMOBI, INNOPLEXUS, INNOVACCER, INTERGAL UNIVERSITY, IQUANTI, ISB, ITTIAM, IVP</li><br>
    <li><strong>J: </strong> IVY-COMTECH, J P MORGAN, JSPL, JAYPEE GROUP, JINDAL, JUBILANT</li><br>
    <li><strong>K: </strong> KBR, KEC, KIIT UNIVERSITY, KPMG, KAARYA, KHODIYAR ENGG, KHOLER CERAMIC, KOHLER</li><br>
    <li><strong>L: </strong> L&T, L&T ECC, L&T ENGG., L&T CONSTRUCTION., L&T POWAI, LARSEN & TOUBRO, LEXINNOVA</li><br>
    <li><strong>M: </strong> MN DUSTUR, MAHINDRA FINANCE, MAHINDRA & MAHINDRA, MANGLYATAN UNIVERSITY, MAQ SOFTWARE, MARUTI SUZUKI, MARVEL, MASTER CARD, MAURUGAPPA GROUP, MECON, MEDANI, MENTOR GRAPHICS, MERCK ASPECT, MEWAR UNIVERSITY, MICROSOFT (India), MICROSOFT (REDMOND), MICROSOFT (SALES), MISYS, MOB STAC, MORGEN STANLEY, MU-SIGMA, MURAAI, MURUGAPPA, MY KAARMA, MYLAN, MYSYS SOFT</li><br>
    <li><strong>N: </strong> NIIT UNIVERSITY, NVIDIA, NAGARRO, NETAPP, NHAI, NISA, NOVARTIS, NOVELL, NUCLEUS, NUTANIX</li><br>
    <li><strong>O: </strong> ONGC, ORACLE (AD), OLA CABS, OLA OPERATION, OLA TECH, OPEN SOLUTIONS, OPTION TOWN, OPTUMSOFT, ORACLE (CGBU), ORACLE (FINANCE), ORACLE (GCS), ORACLE (OFSS), ORACLE (Sever Tech.), ORACLE (APP DEV), ORACLE ELITE, ORACLE OFSS, ORACLE PREMIUM, ORACLE PROFILE, ORACLE SYSTEM, ORACLE US, ORBBEES LTD, ORBEES MEDICAL, OXIGEN, OYO ROOMS</li><br>
    <li><strong>P: </strong> PSIT, PANASONIC, PARUL INSTITUTE, PARUL UNIVERSITY, PAYTM, PAYPAL, PERSITENT, PETROFAC, PGCIL, PHILIPS, PMC SIERRA, POWERGRID, PRACTO, PROPTIGER</li><br>
    <li><strong>Q: </strong> QUALCOMM</li><br>
    <li><strong>R: </strong> RAM SWOROOP, RANBOXY, RELAXO, RELIANCE INDUSTRIES LTD, Reliance Jio, REPPIFY, RESONSNCE, RIVIGO SERVICES, ROCK ON</li><br>
    <li><strong>S: </strong> SRI-B, SRI-B DEV, SRI-D, SRI-N, SRM U, SAINT-GOBIN, SANDIP UNIVERSITY, SAP LABS, SAPIENT, SCA TECH., SEARS, SERVICE NOW, SHARDA GROUP, SIGMOID, SISA GOA Mining, SKYTECH CHATTERJEE, SNAM ALLOYS, SNAPDEAL, SOCIETE GENERALE, SODEL SOLUTION, SONY, SRIJAN INDIA, SRM UNIVERSITY, STERLITE TECH, SUCCES FACTORS, SUN PHARMA</li><br>
    <li><strong>T: </strong> TCS, TCS (R & D), TAKSHILA EDUCA., TATA COMMUNICATION, TATA MOTORS, TATA STEEL, TAVANT, TECHNIP, TEXAS INSTRUMENTS, THERMAZ, TIMES INTERNET, TISCO, TOLEXO, TOWER RESEARCH, TREDENCE, TRIDENT GROUP, TRITHANKAR UNIVERSITY</li><br>
    <li><strong>U: </strong> UTC, UBER, UNITED HEALTH GROUP</li><br>
    <li><strong>V: </strong> V E COMMERCIAL, VMWARE SOFTWARE, VALUE EDGE, VE COMMERCIAL, VEDANTA, VENKATESH INSTITUTE, VESUVIUS COM, VIDYAMANDIR CLASS, VIGNAN UNIVERSITY, VIRTUSA, VISA STEEL, VODAFONE, VOGNAN UNIVERSITY</li><br>
    <li><strong>W: </strong> WALMART LABS, WHIZDOM, WIPRO, WOOQER, WORLDQUANT LLC, WORK APPLICATIONS, WORKSAPP, WORLDBIZ</li><br>
    <li><strong>X: </strong> (No recruiters starting with X)</li><br><br><br>

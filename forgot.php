...
<body>
  ...
  <body>
    <div>
      <img id="img2" src="images/u3.jpg" width="550px" style="margin-left: 50%; margin-top: 35px;">
    </div>

    <div class="content">
        <br> <br> 
    <h1 align="center" style="margin-left: 50px; margin-top: -300px;">Forgot Password?</h1> <br>
    <br><br>

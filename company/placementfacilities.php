                                ...
                                class="active" title="Recruiter">
                                                        ...
                                                        <ul class="dropMenu">
                                                                                ...
                                                                                Calender
                                                                                                                                ...
                                                                                                                                <li><a href="pastrecruiter.php" class="inactive" title="pastrecruiter">
                                                                                Past Recruiter
                                        </a></li>
                                        <li><a href="placementfacilities.php" class="active" title="placementfacilities">
...
<section>
<body>
    <h1 style="margin-top: 50px;">UMIT Placement facilities</h1>
 <div class="clearfix " style= "background-color: white">
        ...
        <ul>
            <li>1) Well furnished rooms for interviews and group discussions.</li>
            <li>2) Fully computerized office.</li>
            <li>3) Auditoriums close to the office to conduct pre-placement talks and tests.</li>
            <li>4) Student placement volunteers to assist on the day of visit and through the selection process.</li>
            <li style="margin-bottom: 50px;">5) Video conferencing facilities.</li>
        </ul>
        <p></p>
    </div>

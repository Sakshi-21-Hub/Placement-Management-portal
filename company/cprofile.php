            ...
            <form action="editprofile.php" method="POST">
                <div class="row">
                   ...
                   <div class="form-row ">
                        ...
                        <input type="text" class="form-control" id="uname" name="uname" value="<?php echo $row['uname']; ?>" readonly>
                    </div>
                   </div>
                   <div class="form-row ">
                        <div class="col-md-6 mb-3">
                        <label for="cname">Company Name</label>
                        <input type="text" class="form-control" id="cname" name="companyname" value="<?php echo $row['companyname']; ?>"readonly>
                    </div>
                        <div class="col-md-6 mb-3">
                        <label for="fname">Manager's First Name</label>
                        <input type="text" class="form-control" id="fname" name="managerfname" value="<?php echo $row['managerfname']; ?>"readonly>
                    </div>
                   </div>
                   <div class="form-row ">
                        <div class="col-md-6 mb-3">
                        <label for="lname">Manager's Last Name</label>
                        <input type="text" class="form-control" id="lname" name="managerlname" value="<?php echo $row['managerlname']; ?>"readonly>
                    </div>
                        <div class="col-md-6 mb-3">
                   ...
                   <div class="form-row ">
                        ...
                        <input type="text" class="form-control" id="website" name="website" value="<?php echo $row['website']; ?>"readonly>
                    </div>
                        <div class="col-md-6 mb-3">
                     ...
                     <button type="submit" class="btn col-md-12 mb-3" name="edit"  style=" color: white; width:67%; 

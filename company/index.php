...
<section class="welcome-section" style="background-color: white; padding: 30px; text-align: center;">
    <h1>Welcome,<span style="color:navy;font-weight:bold"></i>&nbsp;<?php echo $_SESSION['username']; ?></span> </h1>
            ...
            <section id="users" class="users" style="margin-top:-10px;">
    ...
    <a href="cprofile.php" class="navy-button btn btn-primary" style="width: 200px; height: 100px; line-height: 100px; display: flex; justify-content: center; align-items: center; text-align: center;">Profile</a>
</div>

            <div class="col d-flex justify-content-center" style="padding: 10px;">
                <a href="editprofile.php" class="navy-button btn btn-primary" style="width: 200px; height:100px; line-height: 100px; display: flex; justify-content: center; align-items: center; text-align: center;">Add Admin</a>
            </div>

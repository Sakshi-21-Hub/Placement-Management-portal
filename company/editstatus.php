...
<section>
    <div class="container">
    <h2 class="text-center mb-5"style="margin-top:1px; color:black;">Edit Students Status</h2>
        <form action="php/editstatus.inc.php" method="POST">
            <?php
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="fname" name="fname" value="<?php echo $row['name']; ?>" readonly>
            </div>
             </div>
             <div class="form-row ">
                        <div class="col-md-6 mb-3">
             ...
             <div class="form-row ">
                ...
                <input type="text" class="form-control" id="jobrole" name="jobrole" value="<?php echo $row['jobrole']; ?>" readonly>
            </div>
         
                        <div class="col-md-6 mb-3">
                <label for="jobtype">Job Type</label>
                <input type="text" class="form-control" id="jobtype" name="jobtype" value="<?php echo $row['jobtype']; ?>" readonly>
            </div>
             </div>
             <div class="form-row ">
                        <div class="col-md-6 mb-3">
                ...
                <select class="form-control" id="status" name="status" required>
                    <option value="round1" <?php echo ($row['status'] == 'round1') ? 'selected' : ''; ?>>Round 1</option>
                    <option value="round2" <?php echo ($row['status'] == 'round2') ? 'selected' : ''; ?>>Round 2</option>
                    <option value="round3" <?php echo ($row['status'] == 'round3') ? 'selected' : ''; ?>>Round 3</option>
             ...
             <div class="form-row justify-content-center">
                <button type="submit" name= "update" class="btn btn-primary btn-block" name="updateclass=" style="color: white; font-weight: bold; width: 65%; background: linear-gradient(to left, #4181ED, #3F4261);">Update</button>
                </div>
            <?php
                    }
                }

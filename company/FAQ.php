...
<body>
<h1>UMIT Placement facilities-FAQ</h1>
    <div class="container">
        <div id="accordion">
            <div class="accordion-item">
                ...
                <div id="collapse1" class="accordion-body collapse">
                    <p>Yes, there are multiple companies recruiting in the same slot. The results of all the companies are announced at the end of the slot and if a student gets multiple offers then he is allowed to choose between one of them and inform the office of his decision before the beginning of the next slot.</p>
                </div>
            </div>
            <div class="accordion-item">
                ...
                <div id="collapse2" class="accordion-body collapse">
                    <p>UMIT follows a One student; One job policy so once the job is registered against the student, he/she is not entitled to sit for any other company.</p>
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <div id="collapse2" class="accordion-body collapse">
                    <p>No. There is no fee associated with the registration or the placement process.</p>
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <div id="collapse2" class="accordion-body collapse">
                    <p>To participate in the Campus Recruitment Program, a company must fill in the Job Notification Form and mail it at tpo@iitbhu.ac.in. The opportunity is posted on the forum and the list of interested students is communicated to the company. You can also find the detailed Placement Procedure here.</p>
                </div>
            </div>
            <div id="accordion">
            <div class="accordion-item">
                <div class="accordion-header" data-toggle="collapse" data-target="#collapse1">
                What are the career services offered by UMIT Training and Placement Cell?</div>
                <div id="collapse1" class="accordion-body collapse">
                <p>The UMIT Training and Placement Cell offers various career services to students, including:</p>
            <ul>
                <li>Internship opportunities with reputed companies</li>
                <li>Placement assistance for full-time job opportunities</li>
                <li>Resume building workshops and interview preparation sessions</li>
                <li>Networking events and industry interactions</li>
                <li>Career counseling and guidance sessions</li>
            </ul>
            <p>These services aim to enhance students' employability and help them secure rewarding career opportunities.</p>
                       </div>
            </div>
            ...
            <div class="accordion-item">
                <div class="accordion-header" data-toggle="collapse" data-target="#collapse1">
                How can I contact the UMIT Training and Placement Cell for further assistance? </div>
                <div id="collapse1" class="accordion-body collapse"> 
                    <p>You can contact the UMIT Training and Placement Cell for further assistance through the following channels:</p>
            <ul>
                <li>Phone: +91-98201 61954</li>
                <li>Email: placement@umit.ac.in</li>
                <li>Visit the placement office during office hours</li>
                <li>Fill out the contact form available on the UMIT website</li>
            </ul>
            <p>Our team is dedicated to providing support and guidance to students regarding their career aspirations and placement-related queries.</p>
                </div>
            </div>

            <div class="accordion-item">
                <div class="accordion-header" data-toggle="collapse" data-target="#collapse2">
                How can one commute between the campus & airport/railway station?</div>
                <div id="collapse2" class="accordion-body collapse">
                <p>There are various modes of transportation available for commuting between the campus and the airport/railway station:</p>
            <ul>
                <li>By taxi: Taxis are readily available outside the campus gates and at the airport/railway station.</li>
                <li>Public transportation: Buses and trains connect the campus to the airport and railway station.</li>
                <li>Pre-arranged transport: Some students and visitors prefer pre-arranged transportation services for convenience.</li>
            </ul>
            <p>You can choose the mode of transportation based on your preference, budget, and convenience.</p>

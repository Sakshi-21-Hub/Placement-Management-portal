            ...
            <div class="menuPage">
                <div class="resMainmenu">
                    ...
                    <ul class="navMenu">
                                ...
                                class="active" title="Recruiter">
                                                                For Recruiter
                                                                 <i class="fa fa-caret-down"></i>  </a>
                                                        <ul class="dropMenu">
                                                                                                <li><a href="placementpolicy.php"class="active" title="Placement Policy">
                                                                                Placement Policy
                                        </a></li>
...
<div class="d-flex justify-content-center">
                <a class="btn btn-primary btn-md" href="https://docs.google.com/forms/d/e/1FAIpQLSecawPV8UVm6ogel68MGFGITiZb3sOUy8vV_QAc04EOnVR8XQ/viewform" target="_blank">JOB ANNOUNCEMENT  FORM</a>
            </div>       
            <p></p>
 </div>
    <script>

...
<body>
        ...
        <div class="container">
            ...
            <form action="php/edit.inc.php" method="POST">
                <div class="row">
                    ...
                    $sql = "SELECT * FROM company WHERE uname='$user';";
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="uname">Company Username</label>
                        <input type="text" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"class="form-control" id="uname" name="uname" value="<?php echo $row['uname']; ?>" readonly>
                    </div>
                    </div>
                    <div class="form-row ">
                    <div class="col-md-6 mb-3">
                        <label for="cname">Company Name</label>
                        <input type="text" pattern="[a-z0-9.-]+"class="form-control" id="cname" name="companyname" value="<?php echo $row['companyname']; ?>">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="fname">Manager's First Name</label>
                        <input type="text" pattern="[a-z0-9.-]+"class="form-control" id="fname" name="managerfname" value="<?php echo $row['managerfname']; ?>">
                    </div>
                    </div>
                    <div class="form-row ">
                    <div class="col-md-6 mb-3">
                        <label for="lname">Manager's Last Name</label>
                        <input type="text" pattern="[a-z0-9.-]+"class="form-control" id="lname" name="managerlname" value="<?php echo $row['managerlname']; ?>">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="email">Email</label>
                        <input type="text"pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"class="form-control" id="email" name="email" value="<?php echo $row['email']; ?>">
                    </div>
                    </div>
                    <div class="form-row ">
                    <div class="col-md-6 mb-3">
                        <label for="phone">Phone</label>
                        <input type="tel" pattern="^\d{10}$" class="form-control" id="phone" name="phone"  value="<?php echo $row['phone']; ?>">
                    </div>
                    <div class="col-md-6 mb-3">
    ...
    <div class="form-row justify-content-center">
    <button class="btn mb-3" style="font-weight: bold; width: 70%; color: white; ">
        <a href="cprofile.php" class="btn btn-secondary" style="width: 90%;">Back to Profile</a>
    </div>
    <br><br>
    </div>

                ...
                <div class="resMainmenu">
                    ...
                    <ul class="navMenu">
                                ...
                                class="active" title="Recruiter">
                                                        ...
                                                        <ul class="dropMenu">
                                                                                                <li><a href="placementpolicy.php"class="inactive" title="Placement Policy">
                                                                                Placement Policy
                                        </a></li>
                                                                                                                                <li><a href="internshippolicy.php" class="inactive" title="Internship Policy">
                                                                                Internship Policy
                                        </a></li>
                                                                                                <li><a href="calender.php"  title="Calender">
                                                                                Calender
                                        </a></li>
                                                                                                                                <li><a href="pastrecruiter.php" class="active" title="pastrecruiter">
                                                                                Past Recruiter
                                        </a></li>

        ...
        <div class="container">
            ...
            <div>
                ...
                if (isset($_POST['signup'])) {
                    ...
                    echo $uname;
                    // if ($pwd1 == $pwd2) {
                    //  $sql = "insert into studentlogin(uname, pnr, pwd, fname, lname, email, phone, secque, secans) values('$uname', '$pwd1', '$fname', '$lname', '$email', '$phone', '$secque', '$secans');";
                    //  mysqli_query($conn, $sql);
                    // }
                }
                ?>
            </div>
            <form action="sregister.inc.php" autocomplete="off" method="POST">
                ...
                Enter a Username (at least 4 characters)</div>
                    </div>
				...
				<div class="form-row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="prn" name="prn" required pattern="^\d{16}$">
                        <div class="invalid-feedback">
                            Enter PRN Number
                        </div>
                    </div>
				  ...
				  <div class="form-row">
					<div class="col-md-6 mb-3">
                        ...
                        <input type="tel" pattern="^\d{10}$" class="form-control" id="phone" name="phone"  required pattern="^\d{10}$">
                        <div class="invalid-feedback">
